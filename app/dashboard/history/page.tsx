...
async function History() {
  ...
  return (
    <div className='m-5 p-5 border rounded-lg bg-[#1b2431] shadow-sm'>
        ...
        <div className='grid grid-cols-7 font-bold mt-5 py-3 px-3 text-white bg-[#141b24]'>
        ...
        {HistoryList.map((item:HISTORY,index:number)=>(
            <div key={index}>
            <div className='grid grid-cols-7 my-5 py-3 px-3 text-white'>
